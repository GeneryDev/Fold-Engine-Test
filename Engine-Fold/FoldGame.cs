...
public class FoldGame : Game
{
    ...
    private readonly FixedSizeFloatBuffer _frameTimes = new FixedSizeFloatBuffer(60);
    ...
    protected override void Draw(GameTime gameTime)
    {
        Time.Update(gameTime);
        Time.TotalFrames++;
        _frameTimes.Put(Time.DeltaTime);
        // Console.WriteLine("FPS: ");
        Time.FramesPerSecond = 1 / _frameTimes.Average();
