...
namespace FoldEngine.Components {
    public static class Component {
        ...
        private static Dictionary<Type, Func<Scene, long, object>> _customInitializers;

        private static readonly Dictionary<Type, ConstructorInfo> _componentSetConstructors =
