...
namespace FoldEngine.Interfaces
{
    ...
    public class RenderingLayer : IRenderingLayer {
        ...
        public Vector2 WindowToLayer(Vector2 point) {
            return (point - Destination.Location.ToVector2()) * Destination.Size.ToVector2() / RenderingUnit.WindowSize.ToVector2();
        }

        public Vector2 LayerToWindow(Vector2 point) {
            return Destination.Location.ToVector2() + point / Destination.Size.ToVector2() * RenderingUnit.WindowSize.ToVector2();
        }
    }
}
