        ...
        public void Serialize(T t, SaveOperation writer) {
            switch(t) {
                case byte v: writer.Write(v);
                    return;
                case sbyte v: writer.Write(v);
                    return;
                
                case short v: writer.Write(v);
                    return;
                case ushort v: writer.Write(v);
                    return;
                
                case int v: writer.Write(v);
                    return;
                case uint v: writer.Write(v);
                    return;
                
                case long v: writer.Write(v);
                    return;
                case ulong v: writer.Write(v);
                    return;
                
                case float v: writer.Write(v);
                    return;
                case double v: writer.Write(v);
                    return;
                case decimal v: writer.Write(v);
                    return;
                
                case bool v: writer.Write(v);
                    return;
