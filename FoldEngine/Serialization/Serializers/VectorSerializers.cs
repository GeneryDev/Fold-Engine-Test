...
namespace FoldEngine.Serialization {
    ...
    public class MatrixSerializer : Serializer<Matrix> {
        public override void Serialize(Matrix mat, SaveOperation writer) {
            writer
                .Write(mat.M11).Write(mat.M12).Write(mat.M13).Write(mat.M14)
                .Write(mat.M21).Write(mat.M22).Write(mat.M23).Write(mat.M24)
                .Write(mat.M31).Write(mat.M32).Write(mat.M33).Write(mat.M34)
                .Write(mat.M41).Write(mat.M42).Write(mat.M43).Write(mat.M44)
            ;
        }
